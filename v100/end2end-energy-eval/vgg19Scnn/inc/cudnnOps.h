...
#ifndef CPPSCNN_CUDNNOPS_H
#define CPPSCNN_CUDNNOPS_H
#include "common.h"
class Conv{
public:
    unsigned int H;
...
public:
    ...
    float *output;
    void initialize(unsigned int b,unsigned int c,unsigned int h,unsigned int w,unsigned int pad,
                    unsigned int windowH,unsigned int windowW,
