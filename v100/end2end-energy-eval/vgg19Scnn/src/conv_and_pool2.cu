...
Conv_and_pool3_14::Conv_and_pool3_14(unsigned int b, unsigned int c, unsigned int h, unsigned int w,
                               unsigned int n1,unsigned int n2,unsigned int n3, string conv1Weight,
                               string conv2Weight, string conv3Weight){
    conv1.initialize(b,c,h,w,n1,1,3,3,1,conv1Weight);
    conv2.initialize(b,n1,h,w,n2,1,3,3,1,conv2Weight);
...
float *Conv_and_pool3_14::forward(float *input, float &t1, float &t2, float &t3) {
    float temp_time;
...
Conv_and_pool3_28::Conv_and_pool3_28(unsigned int b, unsigned int c, unsigned int h, unsigned int w,
                                     unsigned int n1,unsigned int n2,unsigned int n3, string conv1Weight,
                                     string conv2Weight, string conv3Weight){
    conv1.initialize(b,c,h,w,n1,1,3,3,1,conv1Weight);
    conv2.initialize(b,n1,h,w,n2,1,3,3,1,conv2Weight);
...
float *Conv_and_pool3_28::forward(float *input, float &t1, float &t2, float &t3) {
    float temp_time;
    cudaEventRecord(event_start);
    float *x = conv1.forward(input);
    cudaEventRecord(event_stop);
