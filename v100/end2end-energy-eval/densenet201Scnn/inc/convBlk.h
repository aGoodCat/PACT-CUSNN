...
public:
    ...
    unsigned int wOut;
    unsigned int cOut;
    ConvBlk28(unsigned int b, unsigned int c, unsigned int h, unsigned int w,unsigned int n1,unsigned int n2,string bn0Weight,string conv1Weight, string bn1Weight, string conv2Weight);
    BatchNorm conv_block_0_bn;
    Activation conv_block_0_relu;
    Conv conv_block_1_conv;
    BatchNorm conv_block_1_bn;
