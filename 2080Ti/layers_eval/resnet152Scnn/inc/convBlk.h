...
public:
    ...
    ConvBlk1(unsigned int b,unsigned int c,unsigned int h,unsigned int w,string conv0Weight,string bn0Weight,
             string conv1Weight,string bn1Weight,string conv2Weight,string bn2Weight,string conv3Weight,string bn3Weight, bool sparse, int index, float *t1, float *t2);
    int index;
    float *t1;
    float *t2;
...
public:
    ...
    float *t1;
    float *t2;
    ConvBlk8(unsigned int b,unsigned int c,unsigned int h,unsigned int w,string conv1Weight,
             string bn1Weight,string conv2Weight,string bn2Weight,string conv3Weight,string bn3Weight,bool sparse, int index, float *t1, float *t2);
    float *forward(float *input);
};
