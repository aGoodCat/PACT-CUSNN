...
int main(int argc, char *argv[]){
    ...
    Relu relu3;
    relu3.initialize(1,128,112,112,0.55);
    ...
    Relu relu5;
    relu5.initialize(1,256,56,56,0.5);
    ...
    Relu relu6;
    relu6.initialize(1,256,56,56,0.5);
    ...
    Relu relu10;
    relu10.initialize(1,512,14,14,0.1);
    ...
    Relu relu11;
    relu11.initialize(1,512,14,14,0.1);
