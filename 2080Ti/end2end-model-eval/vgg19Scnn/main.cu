...
int main(int argc, char *argv[]){
    ...
    Relu relu1;
    relu1.initialize(1,64,224,224,0.1);
    ...
    Relu relu3;
    relu3.initialize(1,128,112,112,0.5);
    ...
    Relu relu5;
    relu5.initialize(1,256,56,56,0.45);
    ...
    Relu relu6;
    relu6.initialize(1,256,56,56,0.45);
    ...
    block3_conv3_cudnn.initialize(1,256,56,56,256,1,3,3,
                                  1,"../../../weights/vgg19/weights/block3_conv3.bin");
    Relu relu7;
    relu7.initialize(1,256,56,56,0.45);
    ...
    Relu relu9;
    relu9.initialize(1,512,28,28,0.01);
    ...
    block4_conv2_cudnn.initialize(1,512,28,28,512,1,3,3,
                                  1,"../../../weights/vgg19/weights/block4_conv2.bin");
    Relu relu10;
    relu10.initialize(1,512,28,28,0.01);
    ...
    block4_conv3_cudnn.initialize(1,512,28,28,512,1,3,3,
                                  1,"../../../weights/vgg19/weights/block4_conv3.bin");
    Relu relu11;
    relu11.initialize(1,512,28,28,0.01);
    ...
    Relu relu13;
    relu13.initialize(1,512,14,14,0.01);
    ...
    block5_conv2_cudnn.initialize(1,512,14,14,512,1,3,3,
                                  1,"../../../weights/vgg19/weights/block5_conv2.bin");
    Relu relu14;
    relu14.initialize(1,512,14,14,0.01);
    ...
    block5_conv3_cudnn.initialize(1,512,14,14,512,1,3,3,
                                  1,"../../../weights/vgg19/weights/block5_conv3.bin");
    Relu relu15;
    relu15.initialize(1,512,14,14,0.01);
    ...
    if(relu14.sparse){
        ...
        output = block5_conv3_cudnn.forward(output);
    }
    output = relu15.forward(output);
    if(relu15.sparse){
        output = block5_conv4.forward(output);
    }else{
        output = block5_conv4_cudnn.forward(output);
    }
