...
ConvBlk::ConvBlk(unsigned int b, unsigned int c, unsigned int h, unsigned int w, unsigned int n1, unsigned int n2,
...
float * ConvBlk::forward(float *input) {
    ...
    float * conv_block_2_conv_out = conv_block_2_conv.forward(conv_block_1_relu_out);
